...
int get_compartment_index(string compartment_name)
{
  ...
  tuple<string, vector<vector<string>>, vector<vector<string>>> equation_with_compartment_name;
...
tuple<string, bool, vector<vector<string>>> abc(vector<string> equation_vector, bool equation_add, string compartment_name, int compartment_start_index, int index1)
{
  int i=0;
  int compartment_index;
  string eq;
