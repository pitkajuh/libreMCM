...
vector<string> GetParenthesis(const vector<string> &equation, const unsigned open, const unsigned close, unsigned &k, const Data &data, Equation *&e, Equation *&next);
